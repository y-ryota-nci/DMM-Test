		...
		if (res && res.success) {
			...
			.on('click', '#btnSelect', function() {
				...
				if (params && params.callbackParam != undefined) {
					result = {users : entity, callbackParam : params.callbackParam};
				} else {
					result = entity;
				}
				Popup.close(result);
