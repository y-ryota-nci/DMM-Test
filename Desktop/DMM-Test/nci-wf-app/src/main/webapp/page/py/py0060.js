		...
		if (res && res.success) {
			...
			.on('click', '#btnUpdateRequest', function() {
				...
				if (checkTarget) {
					...
					NCI.init("/py0060/validate", params).done(function(res) {
						if (res && res.success) {
							// 変更申請
