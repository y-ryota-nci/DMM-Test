...
/**
 * The persistent class for the MDA_MST database table.
 *
 */
@Entity
@Table(name="MDA_MST")
@NamedQuery(name="MdaMst.findAll", query="SELECT m FROM MdaMst m")
public class MdaMst extends jp.co.nci.iwf.jpa.entity.BaseJpaEntity implements Serializable {
	...
	public MdaMstPK getId() {
		return this.id;
	}

	public void setId(MdaMstPK id) {
		this.id = id;
	}
