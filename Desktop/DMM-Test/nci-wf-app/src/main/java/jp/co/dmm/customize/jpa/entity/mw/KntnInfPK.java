...
/**
 * The primary key class for the KNTN_INF database table.
 * 
 */
@Embeddable
public class KntnInfPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof KntnInfPK)) {
			return false;
		}
		KntnInfPK castOther = (KntnInfPK)other;
		return 
