...
/**
 * 取引先(新規／変更／停止)の申請情報を文書管理側へ連携するためのコールバックファンクション（反社対応用）.
 */
public class CallbackFunctionCoopWf2Doc_SPLR_MST_RLT_PRT extends BaseCoopWf2Doc4DmmCallbackFunction {
	...
	private Long getDocId(String companyCd, String splrCd) {
		...
		final String sql = getSql("SP0000_16");
