...
/**
 * The persistent class for the YR_MST database table.
 * 
 */
@Entity
@Table(name="YR_MST")
@NamedQuery(name="YrMst.findAll", query="SELECT y FROM YrMst y")
public class YrMst extends jp.co.nci.iwf.jpa.entity.BaseJpaEntity implements Serializable {
	...
	public YrMstPK getId() {
		return this.id;
	}

	public void setId(YrMstPK id) {
		this.id = id;
	}
	...
	public String getYrNm() {
		return this.yrNm;
	}

	public void setYrNm(String yrNm) {
		this.yrNm = yrNm;
	}
