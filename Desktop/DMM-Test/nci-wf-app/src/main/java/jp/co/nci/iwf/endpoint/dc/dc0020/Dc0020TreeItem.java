 ...
 * 文書フォルダ階層設定画面のツリーデータ
 */
public class Dc0020TreeItem implements Serializable, DcCodeBook {
	...
	public Dc0020TreeItem(String text) {
		this(text, true);
	}

	public Dc0020TreeItem(MwvDocFolder dfe) {
		this(dfe, true);
	}

	public Dc0020TreeItem(String text, boolean opened) {
	...
	public Dc0020TreeItem(MwvDocFolder dfe, boolean opened) {
