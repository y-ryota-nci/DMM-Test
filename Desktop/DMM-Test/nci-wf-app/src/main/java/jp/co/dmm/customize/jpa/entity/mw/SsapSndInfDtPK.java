...
/**
 * The primary key class for the SSAP_SND_INF_DT database table.
 * 
 */
@Embeddable
public class SsapSndInfDtPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof SsapSndInfDtPK)) {
			return false;
		}
		SsapSndInfDtPK castOther = (SsapSndInfDtPK)other;
		return 
