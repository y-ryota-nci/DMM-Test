...
/**
 * The primary key class for the PAYHYSL_INF database table.
 * 
 */
@Embeddable
public class PayhyslInfPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof PayhyslInfPK)) {
			return false;
		}
		PayhyslInfPK castOther = (PayhyslInfPK)other;
		return 
