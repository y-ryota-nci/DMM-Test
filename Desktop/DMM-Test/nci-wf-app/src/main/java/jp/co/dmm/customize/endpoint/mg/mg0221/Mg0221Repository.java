 ...
 */
@ApplicationScoped
public class Mg0221Repository extends BaseRepository {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public Mg0221Entity get(Mg0221GetRequest req) {
		...
		if (isNotEmpty(req.payApplCd)) {
			sql.append(" and A.PAY_APPL_CD = ? ");
			params.add(req.payApplCd);
		}
	 ...
	 * @return
	 */
	private Mg0221Entity convertEntity(Object[] result) {

		Mg0221Entity entity = new Mg0221Entity();

		entity.companyCd = (String)result[0];
		entity.payApplCd = (String)result[1];
		entity.payApplNm = (String)result[2];
	 ...
	 * @return
	 */
	public int update(Mg0221UpdateRequest req, WfUserRole userRole) {
	 ...
	 * @return
	 */
	public int insert(Mg0221UpdateRequest req, WfUserRole userRole) {
