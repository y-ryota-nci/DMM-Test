...
/**
 * The persistent class for the PAYMAT_INF database table.
 * 
 */
@Entity
@Table(name="PAYMAT_INF")
@NamedQuery(name="PaymatInf.findAll", query="SELECT p FROM PaymatInf p")
public class PaymatInf extends jp.co.nci.iwf.jpa.entity.BaseJpaEntity implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private PaymatInfPK id;
	...
	public PaymatInfPK getId() {
		return this.id;
	}

	public void setId(PaymatInfPK id) {
		this.id = id;
	}
