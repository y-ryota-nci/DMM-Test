...
/**
 * The persistent class for the SSAP_SND_INF_DT database table.
 * 
 */
@Entity
@Table(name="SSAP_SND_INF_DT")
@NamedQuery(name="SsapSndInfDt.findAll", query="SELECT s FROM SsapSndInfDt s")
public class SsapSndInfDt extends jp.co.nci.iwf.jpa.entity.BaseJpaEntity implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private SsapSndInfDtPK id;
	...
	public SsapSndInfDtPK getId() {
		return this.id;
	}

	public void setId(SsapSndInfDtPK id) {
		this.id = id;
	}
	...
	public String getApAccTp() {
		return this.apAccTp;
	}

	public void setApAccTp(String apAccTp) {
		this.apAccTp = apAccTp;
	}
