...
/**
 * The persistent class for the PAYHYSLDTL_INF database table.
 *
 */
@Entity
@Table(name="PAYHYSLDTL_INF")
@NamedQuery(name="PayhysldtlInf.findAll", query="SELECT p FROM PayhysldtlInf p")
public class PayhysldtlInf extends jp.co.nci.iwf.jpa.entity.BaseJpaEntity implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private PayhysldtlInfPK id;
	...
	public PayhysldtlInf() {
	}

	public PayhysldtlInfPK getId() {
		return this.id;
	}

	public void setId(PayhysldtlInfPK id) {
		this.id = id;
	}
