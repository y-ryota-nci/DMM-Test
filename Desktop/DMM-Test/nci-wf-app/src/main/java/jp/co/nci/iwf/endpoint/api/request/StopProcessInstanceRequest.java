...
import jp.co.nci.integrated_workflow.common.CodeMaster.StopProcessType;

public class StopProcessInstanceRequest extends ApiBaseRequest {
	/** 会社コード. */
	...
	/** 削除区分. */
	private String deleteType = StopProcessType.LOGICAL;
	/** 機能スキップフラグ. */
	private boolean isSkipFunction;
	/** 処理ユーザ組織コード */
	...
	/**
	 * 削除区分を設定する.
	 * @param pDeleteType 削除区分

	 */
	public final void setDeleteType(final String pDeleteType) {
		this.deleteType = pDeleteType;
	}
	 ...
	 * @return 機能スキップフラグ
	 */
	public final boolean isSkipFunction() {
		return isSkipFunction;
	}

	/**
	 * 機能スキップフラグを設定する.
	 *
	 * @param isSkipFunction 機能スキップフラグ
	 */
	public final void setSkipFunction(final boolean isSkipFunction) {
		this.isSkipFunction = isSkipFunction;
	}
