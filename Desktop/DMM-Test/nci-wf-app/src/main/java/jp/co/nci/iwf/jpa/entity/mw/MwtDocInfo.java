...
/**
 * The persistent class for the MWT_DOC_INFO database table.
 *
 */
@Entity
@Table(name="MWT_DOC_INFO")
@NamedQuery(name="MwtDocInfo.findAll", query="SELECT m FROM MwtDocInfo m")
public class MwtDocInfo extends MwmBaseJpaEntity implements Serializable {
	...
	private String lockCorporationName;
	...
	private String ownerCorporationName;
	...
	private String publishCorporationName;
	...
	public String getLockCorporationName() {
		return this.lockCorporationName;
	}

	public void setLockCorporationName(String lockCorporationName) {
		this.lockCorporationName = lockCorporationName;
	}
	...
	public String getOwnerCorporationName() {
		return this.ownerCorporationName;
	}

	public void setOwnerCorporationName(String ownerCorporationName) {
		this.ownerCorporationName = ownerCorporationName;
	}
	...
	public String getPublishCorporationName() {
		return this.publishCorporationName;
	}

	public void setPublishCorporationName(String publishCorporationName) {
		this.publishCorporationName = publishCorporationName;
	}
