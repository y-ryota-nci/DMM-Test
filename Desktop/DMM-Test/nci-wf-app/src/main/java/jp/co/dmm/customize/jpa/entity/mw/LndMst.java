...
/**
 * The persistent class for the LND_MST database table.
 *
 */
@Entity
@Table(name="LND_MST")
@NamedQuery(name="LndMst.findAll", query="SELECT l FROM LndMst l")
public class LndMst extends jp.co.nci.iwf.jpa.entity.BaseJpaEntity implements Serializable {
	...
	public LndMstPK getId() {
		return this.id;
	}

	public void setId(LndMstPK id) {
		this.id = id;
	}
	...
	public String getLndCdDjii() {
		return this.lndCdDjii;
	}

	public void setLndCdDjii(String lndCdDjii) {
		this.lndCdDjii = lndCdDjii;
	}
