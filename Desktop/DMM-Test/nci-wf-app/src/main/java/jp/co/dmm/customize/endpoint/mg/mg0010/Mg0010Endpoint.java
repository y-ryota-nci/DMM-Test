...
@RequiredLogin
@WriteAccessLog
public class Mg0010Endpoint extends BaseEndpoint<Mg0010SearchRequest> {

	@Inject private Mg0010Service service;
	...
	@Path("/download")
	@Consumes(MediaType.APPLICATION_JSON)
	public Response download(Mg0010SearchRequest req) {
