...
/**
 * The primary key class for the SPLR_COMPANY_MST database table.
 * 
 */
@Embeddable
public class SplrCompanyMstPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof SplrCompanyMstPK)) {
			return false;
		}
		SplrCompanyMstPK castOther = (SplrCompanyMstPK)other;
		return 
