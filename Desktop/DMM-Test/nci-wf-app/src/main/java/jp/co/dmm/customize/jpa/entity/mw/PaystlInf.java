...
/**
 * The persistent class for the PAYSTL_INF database table.
 * 
 */
@Entity
@Table(name="PAYSTL_INF")
@NamedQuery(name="PaystlInf.findAll", query="SELECT p FROM PaystlInf p")
public class PaystlInf extends jp.co.nci.iwf.jpa.entity.BaseJpaEntity implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private PaystlInfPK id;
	...
	public PaystlInfPK getId() {
		return this.id;
	}

	public void setId(PaystlInfPK id) {
		this.id = id;
	}
