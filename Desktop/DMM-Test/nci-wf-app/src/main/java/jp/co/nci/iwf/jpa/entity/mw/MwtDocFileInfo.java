...
/**
 * The persistent class for the MWT_DOC_FILE_INFO database table.
 *
 */
@Entity
@Table(name="MWT_DOC_FILE_INFO")
@NamedQuery(name="MwtDocFileInfo.findAll", query="SELECT m FROM MwtDocFileInfo m")
public class MwtDocFileInfo extends MwmBaseJpaEntity implements Serializable {
