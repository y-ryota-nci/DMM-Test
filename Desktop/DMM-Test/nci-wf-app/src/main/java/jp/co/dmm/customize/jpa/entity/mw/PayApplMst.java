...
/**
 * The persistent class for the PAY_APPL_MST database table.
 * 
 */
@Entity
@Table(name="PAY_APPL_MST")
@NamedQuery(name="PayApplMst.findAll", query="SELECT p FROM PayApplMst p")
public class PayApplMst extends jp.co.nci.iwf.jpa.entity.BaseJpaEntity implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private PayApplMstPK id;
	...
	public PayApplMstPK getId() {
		return this.id;
	}

	public void setId(PayApplMstPK id) {
		this.id = id;
	}
	...
	public String getPayApplNm() {
		return this.payApplNm;
	}

	public void setPayApplNm(String payApplNm) {
		this.payApplNm = payApplNm;
	}
