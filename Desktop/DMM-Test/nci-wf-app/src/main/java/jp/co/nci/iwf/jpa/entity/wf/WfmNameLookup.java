...
/**
 * The persistent class for the WFM_NAME_LOOKUP database table.
 * 
 */
@Entity
@Table(name="WFM_NAME_LOOKUP")
@NamedQuery(name="WfmNameLookup.findAll", query="SELECT w FROM WfmNameLookup w")
public class WfmNameLookup extends jp.co.nci.iwf.jpa.entity.BaseJpaEntity implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private WfmNameLookupPK id;
	...
	public WfmNameLookup() {
	}

	public WfmNameLookupPK getId() {
		return this.id;
	}

	public void setId(WfmNameLookupPK id) {
		this.id = id;
	}
