 ...
 */
@ApplicationScoped
public class Mg0281Repository extends BaseRepository {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public Mg0281Entity get(Mg0281GetRequest req) {
		...
		if (isNotEmpty(req.mdaId)) {
			sql.append(" and A.MDA_ID = ? ");
			params.add(req.mdaId);
		}
	 ...
	 * @return
	 */
	private Mg0281Entity convertEntity(Object[] result) {

		Mg0281Entity entity = new Mg0281Entity();

		entity.companyCd = (String)result[0];
		entity.mdaId = (String)result[1];
		entity.mdaNm = (String)result[2];
	 ...
	 * @return
	 */
	public int update(Mg0281UpdateRequest req, WfUserRole userRole) {
	 ...
	 * @return
	 */
	public int insert(Mg0281UpdateRequest req, WfUserRole userRole) {
