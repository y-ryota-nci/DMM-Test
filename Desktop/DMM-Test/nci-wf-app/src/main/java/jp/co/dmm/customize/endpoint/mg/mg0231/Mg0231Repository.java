 ...
 */
@ApplicationScoped
public class Mg0231Repository extends BaseRepository {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public Mg0231Entity get(Mg0231GetRequest req) {
	 ...
	 * @return
	 */
	private Mg0231Entity convertEntity(Object[] result) {

		Mg0231Entity entity = new Mg0231Entity();

		entity.companyCd = (String)result[0];
		entity.payCondCd = (String)result[1];
		entity.payCondNm = (String)result[2];
		entity.dltFg = (String)result[3];
	 ...
	 * @return
	 */
	public int update(Mg0231UpdateRequest req, WfUserRole userRole) {

		// SQL
		StringBuilder updateSql = new StringBuilder(getSql("MG0230_03"));
	 ...
	 * @return
	 */
	public int insert(Mg0231UpdateRequest req, WfUserRole userRole) {

		// SQL
		StringBuilder insertSql = new StringBuilder(getSql("MG0230_04"));
