...
/**
 * The persistent class for the BGT_PLN database table.
 *
 */
@Entity
@Table(name="BGT_PLN")
@NamedQuery(name="BgtPln.findAll", query="SELECT b FROM BgtPln b")
public class BgtPln extends jp.co.nci.iwf.jpa.entity.BaseJpaEntity implements Serializable {
	...
	public BgtPlnPK getId() {
		return this.id;
	}

	public void setId(BgtPlnPK id) {
		this.id = id;
	}
