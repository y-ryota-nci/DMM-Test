 ...
 */
@BizLogic
public class Rm0500Service extends MmBaseService<WfmMenuRole> {
	@Inject
	 ...
	 * @return
	 */
	public Rm0500Response init(Rm0500Request req) {
		final Rm0500Response res = createResponse(Rm0500Response.class, req);
	 ...
	 * @return
	 */
	public Rm0500Response search(Rm0500Request req) {
...
//		inParam.setOrderBy(toOrderBy(req, ""));
		...
		final Rm0500Response res = createResponse(Rm0500Response.class, req, allCount);
