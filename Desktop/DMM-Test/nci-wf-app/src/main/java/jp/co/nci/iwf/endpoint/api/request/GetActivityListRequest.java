...
import jp.co.nci.integrated_workflow.common.CodeMaster.TrayLinkType;
...
public class GetActivityListRequest extends ApiBaseRequest {
	...
	public static final class Mode {
		...
		private Mode() { }
		/** ユーザトレイ. */
		public static final String USER_TRAY = "01";
		/** グループトレイ. */
		public static final String GROUP_TRAY = "02";
		/** 共有ユーザトレイ. */
		public static final String INFORMATION_SHARER_TRAY = "03";
		/** 集約トレイ. */
		public static final String PROCESS_AGGREGATION_TRAY = "05";
		/** 自案件トレイ. */
		public static final String OWN_PROCESS_TRAY = "06";
		/** ルート変更トレイ. */
		public static final String ROUTE_UPD_TRAY = "07";
		/** 会社トレイ. */
		public static final String CORPORATION_TRAY = "08";
		/** 全トレイ. */
		public static final String ALL_TRAY = "09";
		/** 会社トレイ(アクティビティ集約). */
		public static final String CORPORATION_DISTINCT_TRAY = "10";
		/** ユーザトレイ(ユーザ指定). */
		public static final String USER_TRAY_USER = "11";
		/** ユーザトレイ(グループ指定). */
		public static final String USER_TRAY_GROUP = "12";
		/** 送信トレイ. */
		public static final String SEND_TRAY = "13";
		/** 受信トレイ. */
		public static final String RECEIVE_TRAY = "14";
		/** 滞留トレイ. */
		public static final String STAY_TRAY = "15";
	}
	...
	public static final class StatusType {
		/** 決裁前. */
		public static final String NOT_APPROVED = "1";
		/** 確認前 */
	...
	public static final class SortType {
		...
		/** 処理依頼昇順. */
		public static final String REQUEST_ASC				= "4";
		/** 処理依頼降順. */
		public static final String REQUEST_DESC				= "5";
		/** 業務ステータス昇順. */
		public static final String BUSINESS_STATUS_ASC		= "6";
		/** 業務ステータス降順. */
		public static final String BUSINESS_STATUS_DESC		= "7";
	}
	...
	/** 連携区分. */
	private String trayLinkType = TrayLinkType.VALUE;
	/** 連携ID. */
	private String trayLinkId;
	/** row no. */
	private Long rowNo;
	/** row count. */
	...
	public static final class SelectMode {
		/** 両方(データ＋カウント). */
		public static final String BOTH = CodeMaster.SelectMode.BOTH;
		/** データのみ */
		public static final String DATA = CodeMaster.SelectMode.DATA;
		/** カウントのみ */
		public static final String COUNT = CodeMaster.SelectMode.COUNT;
	}
	...
	/**
	 * プロセス集約ID.を設定します.
	 * @param pProcessIdAggregation プロセス集約ID.
	 */
	...
	/**
	 * 伝票種類コードのリスト.を設定します.
	 * @param pProcessCategoryDefCodeList 伝票種類コードのリスト.
	 */
	...
	/**
	 * ステータス指定を設定する.
	 * @param statusType ステータス指定
	 */
	public final void setStatusType(final String statusType) {
	...
	/**
	 * 業務管理情報01.を設定します.
	 * @param pBusinessInfo01 業務管理情報01.
	 */
	...
	/**
	 * 業務管理情報02.を設定します.
	 * @param pBusinessInfo02 業務管理情報02.
	 */
	...
	/**
	 * 業務管理情報03.を設定します.
	 * @param pBusinessInfo03 業務管理情報03.
	 */
	...
	/**
	 * 業務管理情報04.を設定します.
	 * @param pBusinessInfo04 業務管理情報04.
	 */
	...
	/**
	 * 業務管理情報05.を設定します.
	 * @param pBusinessInfo05 業務管理情報05.
	 */
	...
	/**
	 * 業務管理情報06.を設定します.
	 * @param pBusinessInfo06 業務管理情報06.
	 */
	...
	/**
	 * 業務管理情報07.を設定します.
	 * @param pBusinessInfo07 業務管理情報07.
	 */
	...
	/**
	 * 業務管理情報08.を設定します.
	 * @param pBusinessInfo08 業務管理情報08.
	 */
	...
	/**
	 * 業務管理情報09.を設定します.
	 * @param pBusinessInfo09 業務管理情報09.
	 */
	...
	/**
	 * 業務管理情報10.を設定します.
	 * @param pBusinessInfo10 業務管理情報10.
	 */
	...
	/**
	 * 期限切れ指定.を設定します.
	 * @param pIsExpired 期限切れ指定.
	 */
	public final void setExpired(final boolean pIsExpired) {
		this.isExpired = pIsExpired;
	}
	...
	/**
	 * 検索条件.を設定します.
	 * @param pSearchConditionList 検索条件.
	 */
	...
	/**
	 * 業務ﾌﾟﾛｾｽ状態のﾘｽﾄを取得する.
	 * @return businessProcessList 業務ﾌﾟﾛｾｽ状態のﾘｽﾄ
	 */
	...
	/**
	 * 業務ﾌﾟﾛｾｽ状態のﾘｽﾄを設定する.
	 * @param pBusinessProcessList セットする businessProcessList
	 */
	public final void setBusinessProcessStatusList(final List<String> pBusinessProcessList) {
		this.businessProcessStatusList = pBusinessProcessList;
	}
	/**
	 * @return linkKind
	 */
	public final String getTrayLinkType() {
		return trayLinkType;
	}
	/**
	 * @param pLinkKind セットする linkKind
	 */
	public final void setTrayLinkType(final String pLinkKind) {
		this.trayLinkType = pLinkKind;
	}
	/**
	 * @return linkId
	 */
	public final String getTrayLinkId() {
		return trayLinkId;
	}
	/**
	 * @param pLinkId セットする linkId
	 */
	public final void setTrayLinkId(final String pLinkId) {
		this.trayLinkId = pLinkId;
	}
