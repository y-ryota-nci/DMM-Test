...
/**
 * The persistent class for the BUMONEXPS_MST database table.
 * 
 */
@Entity
@Table(name="BUMONEXPS_MST")
@NamedQuery(name="BumonexpsMst.findAll", query="SELECT b FROM BumonexpsMst b")
public class BumonexpsMst extends jp.co.nci.iwf.jpa.entity.BaseJpaEntity implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private BumonexpsMstPK id;
	...
	public BumonexpsMstPK getId() {
		return this.id;
	}

	public void setId(BumonexpsMstPK id) {
		this.id = id;
	}
