...
/**
 * The persistent class for the TAXEXPS_MST database table.
 * 
 */
@Entity
@Table(name="TAXEXPS_MST")
@NamedQuery(name="TaxexpsMst.findAll", query="SELECT t FROM TaxexpsMst t")
public class TaxexpsMst extends jp.co.nci.iwf.jpa.entity.BaseJpaEntity implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private TaxexpsMstPK id;
	...
	public TaxexpsMstPK getId() {
		return this.id;
	}

	public void setId(TaxexpsMstPK id) {
		this.id = id;
	}
