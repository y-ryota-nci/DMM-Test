...
/**
 * The primary key class for the RLT_PRT_MST database table.
 * 
 */
@Embeddable
public class RltPrtMstPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof RltPrtMstPK)) {
			return false;
		}
		RltPrtMstPK castOther = (RltPrtMstPK)other;
		return 
