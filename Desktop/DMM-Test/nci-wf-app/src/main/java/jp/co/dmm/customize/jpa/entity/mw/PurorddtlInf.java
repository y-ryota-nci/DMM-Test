...
/**
 * The persistent class for the PURORDDTL_INF database table.
 *
 */
@Entity
@Table(name="PURORDDTL_INF")
@NamedQuery(name="PurorddtlInf.findAll", query="SELECT p FROM PurorddtlInf p")
public class PurorddtlInf extends jp.co.nci.iwf.jpa.entity.BaseJpaEntity implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private PurorddtlInfPK id;
	...
	@Column(name="PURORD_SMRY")
	private String purordSmry;
	...
	public PurorddtlInfPK getId() {
		return this.id;
	}

	public void setId(PurorddtlInfPK id) {
		this.id = id;
	}
	...
	public String getPurordSmry() {
		return this.purordSmry;
	}

	public void setPurordSmry(String purordSmry) {
		this.purordSmry = purordSmry;
	}
