...
/**
 * The persistent class for the BUYDTL_INF database table.
 *
 */
@Entity
@Table(name="BUYDTL_INF")
@NamedQuery(name="BuydtlInf.findAll", query="SELECT b FROM BuydtlInf b")
public class BuydtlInf extends jp.co.nci.iwf.jpa.entity.BaseJpaEntity implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private BuydtlInfPK id;
	...
	@Column(name="BUY_AMT_FC")
	private BigDecimal buyAmtFc;

	@Column(name="BUY_AMT_JPY")
	private BigDecimal buyAmtJpy;

	@Column(name="BUY_AMT_JPY_INCTAX")
	private BigDecimal buyAmtJpyInctax;

	@Column(name="BUY_UC_FC")
	private BigDecimal buyUcFc;

	@Column(name="BUY_UC_JPY")
	private BigDecimal buyUcJpy;
	...
	public BuydtlInfPK getId() {
		return this.id;
	}

	public void setId(BuydtlInfPK id) {
		this.id = id;
	}
	...
	public BigDecimal getBuyAmtFc() {
		return this.buyAmtFc;
	}

	public void setBuyAmtFc(BigDecimal buyAmtFc) {
		this.buyAmtFc = buyAmtFc;
	}

	public BigDecimal getBuyAmtJpy() {
		return this.buyAmtJpy;
	}

	public void setBuyAmtJpy(BigDecimal buyAmtJpy) {
		this.buyAmtJpy = buyAmtJpy;
	}

	public BigDecimal getBuyAmtJpyInctax() {
		return this.buyAmtJpyInctax;
	}

	public void setBuyAmtJpyInctax(BigDecimal buyAmtJpyInctax) {
		this.buyAmtJpyInctax = buyAmtJpyInctax;
	}

	public BigDecimal getBuyUcFc() {
		return this.buyUcFc;
	}

	public void setBuyUcFc(BigDecimal buyUcFc) {
		this.buyUcFc = buyUcFc;
	}

	public BigDecimal getBuyUcJpy() {
		return this.buyUcJpy;
	}

	public void setBuyUcJpy(BigDecimal buyUcJpy) {
		this.buyUcJpy = buyUcJpy;
	}
