...
/**
 * The primary key class for the SSAP_SND_INF database table.
 * 
 */
@Embeddable
public class SsapSndInfPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof SsapSndInfPK)) {
			return false;
		}
		SsapSndInfPK castOther = (SsapSndInfPK)other;
		return 
