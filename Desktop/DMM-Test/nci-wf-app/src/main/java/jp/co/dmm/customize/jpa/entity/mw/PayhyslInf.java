...
/**
 * The persistent class for the PAYHYSL_INF database table.
 * 
 */
@Entity
@Table(name="PAYHYSL_INF")
@NamedQuery(name="PayhyslInf.findAll", query="SELECT p FROM PayhyslInf p")
public class PayhyslInf extends jp.co.nci.iwf.jpa.entity.BaseJpaEntity implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private PayhyslInfPK id;
	...
	@Column(name="PAYHYS_NO_O")
	private String payhysNoO;
	...
	@Column(name="SSAP_SND_NO_B_RCNT")
	private String ssapSndNoBRcnt;
	...
	public PayhyslInfPK getId() {
		return this.id;
	}

	public void setId(PayhyslInfPK id) {
		this.id = id;
	}
	...
	public String getPayhysNoO() {
		return this.payhysNoO;
	}

	public void setPayhysNoO(String payhysNoO) {
		this.payhysNoO = payhysNoO;
	}
	...
	public String getSsapSndNoBRcnt() {
		return this.ssapSndNoBRcnt;
	}

	public void setSsapSndNoBRcnt(String ssapSndNoBRcnt) {
		this.ssapSndNoBRcnt = ssapSndNoBRcnt;
	}
