...
/**
 * The persistent class for the ITMEXPS2_CHRMST database table.
 * 
 */
@Entity
@Table(name="ITMEXPS2_CHRMST")
@NamedQuery(name="Itmexps2Chrmst.findAll", query="SELECT i FROM Itmexps2Chrmst i")
public class Itmexps2Chrmst extends jp.co.nci.iwf.jpa.entity.BaseJpaEntity implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private Itmexps2ChrmstPK id;
	...
	public Itmexps2Chrmst() {
	}

	public Itmexps2ChrmstPK getId() {
		return this.id;
	}

	public void setId(Itmexps2ChrmstPK id) {
		this.id = id;
	}
