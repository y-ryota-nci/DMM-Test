...
/**
 * The primary key class for the SPLR_MST database table.
 * 
 */
@Embeddable
public class SplrMstPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof SplrMstPK)) {
			return false;
		}
		SplrMstPK castOther = (SplrMstPK)other;
		return 
