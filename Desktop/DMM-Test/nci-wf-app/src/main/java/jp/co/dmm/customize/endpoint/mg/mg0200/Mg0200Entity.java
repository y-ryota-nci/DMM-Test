...
/**
 * 会計カレンダマスタ一覧の検索結果エンティティ
 */
@Entity
@Access(AccessType.FIELD)
public class Mg0200Entity extends jp.co.nci.iwf.jpa.entity.BaseJpaEntity {
	/** 休日区分 */
	public static final String HLDAY_TP_NORMAL = "0";
	public static final String HLDAY_TP_HOLIDAY = "1";
	/** 決済区分 */
	public static final String STL_TP_OVERLAP = "1";
	public static final String STL_TP_CURRENT = "2";
