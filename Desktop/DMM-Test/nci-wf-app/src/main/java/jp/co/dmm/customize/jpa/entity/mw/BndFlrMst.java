...
/**
 * The persistent class for the BND_FLR_MST database table.
 * 
 */
@Entity
@Table(name="BND_FLR_MST")
@NamedQuery(name="BndFlrMst.findAll", query="SELECT b FROM BndFlrMst b")
public class BndFlrMst extends jp.co.nci.iwf.jpa.entity.BaseJpaEntity implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private BndFlrMstPK id;

	@Column(name="BND_FLR_NM")
	private String bndFlrNm;
	...
	public BndFlrMstPK getId() {
		return this.id;
	}

	public void setId(BndFlrMstPK id) {
		this.id = id;
	}

	public String getBndFlrNm() {
		return this.bndFlrNm;
	}

	public void setBndFlrNm(String bndFlrNm) {
		this.bndFlrNm = bndFlrNm;
	}
